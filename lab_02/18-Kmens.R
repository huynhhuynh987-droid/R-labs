...
#   
#   Random - Chọn ngẫu nhiên K điểm làm centroids
# K-Means++ - Chọn thông minh để centroids xa nhau
# Random Partition - Gán ngẫu nhiên, rồi tính centroids
...
# 
# K-Means BẮT BUỘC phải biết K trước khi chạy. Trong thực tế: - Không biết dữ liệu có bao nhiêu nhóm tự nhiên - Không có “đáp án đúng” (dữ liệu không có nhãn) - K khác nhau → Kết quả hoàn toàn khác
# 
