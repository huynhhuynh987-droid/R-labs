...
prob1 <- choose(4,3) / total
cat("Câu 1a - 3 lá đều là Át:", prob1, "\n")

prob2 <- choose(4,2) * choose(48,1) / total
cat("Câu 1b - Đúng 2 lá Át:", prob2, "\n")

prob3 <- 1 - choose(48,3) / total
cat("Câu 1c - Ít nhất 1 lá Át:", prob3, "\n")
...
p1 <- choose(6,3) / total
cat("Câu 2a - 3 viên đỏ:", p1, "\n")

p2 <- choose(6,2) * choose(4,1) / total
cat("Câu 2b - Đúng 2 viên đỏ:", p2, "\n")

p3 <- 1 - choose(4,3) / total
cat("Câu 2c - Ít nhất 1 viên đỏ:", p3, "\n")
...
cat("Câu 3b - Đúng 2 nữ:", p2, "\n")

p3 <- 1 - choose(15,4) / total
cat("Câu 3c - Ít nhất 1 nữ:", p3, "\n")
# ------------------------------------------------------------------------------
...
jackpot <- 1 / total
cat("Xác suất trúng Jackpot:", jackpot, "\n")

giai2 <- choose(6,5) * choose(39,1) / total
cat("Xác suất trúng 5 số:", giai2, "\n")
...
# Có lặp
repeat_case <- 10^6
cat("Mật khẩu có lặp:", repeat_case, "\n")

# Không lặp
no_repeat <- factorial(10) / factorial(4)
cat("Mật khẩu không lặp:", no_repeat, "\n")
# ==============================================================================
# CÂU HỎI ÔN TẬP
# ==============================================================================
